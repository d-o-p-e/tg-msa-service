...
public class CampaignController {
    ...
    @Operation(summary = "마일리지 조회", description = "보유중인 마일리지를 조회합니다.")
    @GetMapping("/mileage")
    public ResponseEntity<UserMileageResponseDto> getMileage() {
        SessionUserVo sessionUserVo = UserContext.getContext();
        return ResponseEntity.ok().body(campaignService.getMileage(sessionUserVo.getId()));
    }
